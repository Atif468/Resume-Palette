...
<div className="bg-gray-100 min-h-screen py-8" >
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8" ref={componentref}>
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center">
          ...
          <a href="https://leetcode.com/u/Atif_32395" target="_blank" rel="noopener noreferrer" className="mr-4">
            {/* <img src="leetcode_logo.png" alt="LeetCode" className="h-6 w-6" /> */}
            leetcode
          </a>
          <a href="https://www.geeksforgeeks.org/" target="_blank" rel="noopener noreferrer" className="mr-4">
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700">
          Experienced web developer with a strong background in React.js and Node.js. Skilled in front-end and back-end development, as well as version control and agile methodologies.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">Education</h2>
        <p className="text-lg font-semibold mb-1">Bachelor of Science in Computer Science</p>
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600">Developed a fully functional e-commerce website using React.js and Node.js.</p>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-semibold mb-1">Portfolio Website</h3>
          <p className="text-gray-600">Designed and developed a personal portfolio website showcasing skills and projects.</p>
        </div>
      </section>
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">Honors & Awards</h2>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6">
          ...
          <li>Agile Certified Practitioner - Project Management Institute</li>
        </ul>
      </section>
      <section className="mb-6">
